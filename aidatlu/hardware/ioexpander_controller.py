...
class IOControl(object):
    ...
    def _set_ioexpander_polarity(self, io_exp: int, exp_id: int, cmd_byte: int, polarity: bool = False) -> None:
    ...
    def _set_ioexpander_direction(self, io_exp: int, exp_id: int, cmd_byte: int, direction: str = "input") -> None:
        ...
        self.i2c.write(self.i2c.modules["%s_%.1s" %(exp, exp_id)], cmd_byte, 1 if direction == "input" else 0,)

    def _set_ioexpander_output(self, io_exp: int, exp_id: int, cmd_byte: int, value: int) -> None:
        ...
        self.i2c.write(self.i2c.modules["%s_%.1s" %(exp, exp_id)], cmd_byte, value & 0xFF)
