...
class DataParser(object):
    ...
    def __init__(self) -> None:
        ...
        ('input4', 'bool'), ('input5', 'bool'), ('input6', 'bool'), ('sc1', 'u4'), ('sc2', 'u4'), ('sc3', 'u4'), ('sc4', 'u4'), ('sc5', 'u4'), ('sc6', 'u4')])
    ...
    def parse(self, filepath_in: str,  filepath_out: str) -> None:
        ...
        data = self.transform_data(table['w0'], table['w1'], table['w2'], table['w3'], table['w4'], table['w5'])
    ...
    def write_data(self, filepath: str, data: np.array) -> None:
        ...
        with tb.open_file(filepath,  mode='w', title='TLU_interpreted') as h5_file:
            data_table = self._create_table(h5_file, name='interpreted_data', title='data', dtype=self.features)
